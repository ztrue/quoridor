exports.__proto__ = require(PATH_CONTROLLERS + 'abstractController');
...
exports.resetSockets = function() {
  ...
  this.emitAll(this.Events.server.RESET_UID);
};
 ...
 */
exports.onCommand = function(socket, data, callback) {
...
/**
 * @see abstractController::onConnection()
 */
...
/**
 * @see abstractController::onDisconnect()
 */
 ...
 * @param {function(?string, Object)} callback Event callback
 */
exports.onExit = function(socket, data, callback) {
  var index = this.exit(socket.id);
 ...
 * @param {function(?string, Object)} callback Event callback
 */
exports.onGetState = function(socket, data, callback) {
  callback(null, {
    state: this.state
  });
};
 ...
 * @param {function(?string, Object)} callback Event callback
 */
exports.onJoin = function(socket, data, callback) {
...
exports.setState = function() {
  this.emitAll(this.Events.server.SET_STATE, {
    state: this.state
  });
};
